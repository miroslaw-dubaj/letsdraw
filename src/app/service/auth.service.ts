...
export class AuthService {
  ...
  constructor(
    ...
    this.user
      .pipe(
        filter((data : firebase.User) => data != null)
      )
      .subscribe((data) => {
  ...
  signup(
    ...
    this.firebaseAuth
      ...
      .then((value) => {
        this.snackBar.open(
          this.translate.instant('user.created') + ' ' + value.user?.email,
  ...
  login(
    ...
    this.firebaseAuth
      ...
      .then((value) => {
        this.snackBar.open(
          this.translate.instant('user.logged'),
          this.translate.instant('notification.success'),
          {
            duration: 5000,
            panelClass: 'snackbar-success',
  ...
  getCurrentUser(): User | undefined {
    const usr = this.usersService.users.find(
